...
// For IE8 and IE9.
	...
	var escapeTextForBrowser = _dereq_(128);
	var memoizeStringOnly = _dereq_(156);
	var warning = _dereq_(167);
	...
	var createNodesFromMarkup = _dereq_(123);
...
// https://people.mozilla.org/~jorendorff/es6-draft.html#sec-object.assign
	...
	var ReactComponentBase = _dereq_(40);
	var ReactClass = _dereq_(38);
	var ReactContext = _dereq_(45);
	var ReactCurrentOwner = _dereq_(46);
	var ReactElement = _dereq_(63);
	var ReactElementValidator = _dereq_(64);
	var ReactDOM = _dereq_(47);
	var ReactDOMComponent = _dereq_(49);
...
// does not start and if it doesn't, we just call the end listener immediately.
	...
	var keyMirror = _dereq_(153);
	var keyOf = _dereq_(154);
	var monitorCodeUse = _dereq_(157);
 ...
 *   });
	...
	var ReactComponent = _dereq_(39);
	var ReactComponentEnvironment = _dereq_(42);
	var ReactContext = _dereq_(45);
	var ReactCurrentOwner = _dereq_(46);
	var ReactElement = _dereq_(63);
	var ReactInstanceMap = _dereq_(72);
...
// http://www.w3.org/TR/REC-xml/#NT-Name
	...
	var ReactDOMComponent = _dereq_(49);
	var ReactDOMButton = _dereq_(48);
	var ReactDOMForm = _dereq_(50);
	...
	var createFullPageComponent = _dereq_(122);
	...
	var performanceNow = _dereq_(160);
 ...
 * }
	...
	var emptyObject = _dereq_(127);
	var containsNode = _dereq_(120);
	var getReactRootElementInContainer = _dereq_(141);
	var instantiateReactComponent = _dereq_(146);
	var invariant = _dereq_(147);
	var setInnerHTML = _dereq_(161);
	var shouldUpdateReactComponent = _dereq_(163);
...
// See `createPrimitiveTypeChecker`.
   ...
   *   })(1);
	...
	var ReactElement = _dereq_(63);
	var ReactBrowserEventEmitter = _dereq_(33);
	var ReactCompositeComponent = _dereq_(44);
	var ReactInstanceHandles = _dereq_(71);
	var ReactInstanceMap = _dereq_(72);
	var ReactMount = _dereq_(75);
	var ReactUpdates = _dereq_(96);
...
// Defeat circular references by requiring this directly.
	...
	var createArrayFrom = _dereq_(121);
	var getMarkupWrap = _dereq_(139);
	var invariant = _dereq_(147);
